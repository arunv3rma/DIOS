<?php
    ...
    // Run Table query
    $sql="select email from mentorprofile where email='".$_SESSION['username']."'";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Please complete your profile before using our services as Mentor 
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="mentordetails.php" method="post">
